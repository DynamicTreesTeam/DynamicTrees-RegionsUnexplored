...
@OnlyIn(Dist.CLIENT)
public class EucalyptusSurfaceRootBlockBakedModel implements IDynamicBakedModel {
...
//        this.modelLocation = modelLocation;
    ...
    public void initModels() {
        for (int r = 0; r < 8; r++) {
            ...
            cores[0][r] = bakeCore(radius, Direction.Axis.Z, this.barkTexture, overlayTexture); //NORTH<->SOUTH
            cores[1][r] = bakeCore(radius, Direction.Axis.X, this.barkTexture, overlayTexture); //WEST<->EAST
        }
    }
