...
public class DTRUCellKits {
    ...
    public static final CellKit SPARSE = new CellKit(DynamicTreesRU.location("sparse")){
    ...
    public static final CellKit EUCALYPTUS = new CellKit(DynamicTreesRU.location("eucalyptus")) {
    ...
    public static final CellKit POPLAR = new CellKit(DynamicTreesRU.location( "poplar")) {
    ...
    public static final CellKit BAMBOO = new CellKit(DynamicTreesRU.location( "bamboo")) {
    ...
    public static final CellKit COBALT = new CellKit(DynamicTreesRU.location("cobalt")) {
