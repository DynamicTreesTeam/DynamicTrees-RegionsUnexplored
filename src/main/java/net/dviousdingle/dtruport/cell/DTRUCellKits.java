...
public class DTRUCellKits {
    ...
    public static final CellKit DOME = new CellKit(DtruPort.location("dome")) {
    ...
    public static final CellKit JOSHUA = new CellKit(DtruPort.location("joshua")) {
    ...
    public static final CellKit WILLOW = new CellKit(DtruPort.location("willow")) {
