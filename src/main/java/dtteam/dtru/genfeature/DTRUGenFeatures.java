...
public class DTRUGenFeatures {
    ...
    public static final GenFeature SOIL_PREDICATE = new DontGenerateOnSoilGenFeature(new ResourceLocation(DynamicTreesRU.MOD_ID, "soil_predicate"));
    ...
    public static void register(final Registry<GenFeature> registry) {
        registry.registerAll(BIG_BOTTOM_FLARE, EXTRA_BOTTOM_FLARE,
                REPLACE_ON_RADIUS,
                BIOME_PREDICATE_2, SOIL_PREDICATE,
